				...
				<div class="row">
					...
					<div class="col-sm-3">
						<div class="search_box pull-right">
							<input name="pesquisar" type="text" placeholder="Pesquisar Produtos"/>
						</div>
					</div>
				<input type="submit" href="pesquisa.php" value="Buscar" 
											 style="border:none; float:left; height:32px; 
											 border-radius:0 7px 7px 0; width:70px; 
